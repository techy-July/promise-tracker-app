...
import { createItemAndRefresh } from '@/lib/actions/categories'
	...
	return (
		<>
			...
			{isOpen && (
				...
				>
					<div
						className="bg-white dark:bg-zinc-900 rounded-lg shadow-lg max-w-md w-full z-50"
						onClick={(e) => e.stopPropagation()}
					>
						{/* Header */}
						<div className="flex items-center justify-between p-6 border-b border-zinc-200 dark:border-zinc-800">
							<h2 className="text-xl font-semibold text-black dark:text-white">Add New Item</h2>
							<button
								type="button"
								onClick={handleClose}
